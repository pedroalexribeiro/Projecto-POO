...
/**
 * Classe NewBarUI serve para criar um local do tipo exposição através da
 * interface gráfica.
 * @author Pedro Ribeiro e Duarte Carvalho
 */
public class NewExposicaoUI extends javax.swing.JFrame {
    /**
     ...
     */
    public NewExposicaoUI(AdminUI returnFrame) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Criar um novo Exposição");

        jLabel2.setText("Nome:");

        jLabel3.setText("Forma Artística:");

        jLabel4.setText("Preço Ingresso:");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(formaArtisticaTF))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jLabel4)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(precoTF, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(formaArtisticaTF, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        String formaArtistica = formaArtisticaTF.getText();
        String preco = precoTF.getText();
        ...
        }else if(formaArtistica == null || formaArtistica.trim().equals("")){
            JOptionPane.showMessageDialog(null, "Fomra Artistica não pode estar vazio!", "InfoBox: Espaço vazio", JOptionPane.INFORMATION_MESSAGE);
        }else if(preco == null || preco.trim().equals("")){
            JOptionPane.showMessageDialog(null, "Preço não pode estar vazio!", "InfoBox: Espaço vazio", JOptionPane.INFORMATION_MESSAGE);
        ...
        returnFrame.adicionarLocalAConvivio(nomeConvivio, new Exposicao(name, formaArtistica, Double.parseDouble(preco), Double.parseDouble(longitude), Double.parseDouble(latitude)));
    ...
    private javax.swing.JTextField formaArtisticaTF;
